...
| L2 | `wet_head_tracker.resized_listener` | `simple_heads_output_sharing_resize` (2581) | `main.c:2642` | `output_resized_signal` | deferred | mirror-of resize propagation (R2c: DRM/remote-bound, deferred with the rest of the mirror path) | — |
